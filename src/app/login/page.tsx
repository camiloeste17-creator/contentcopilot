    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">ContentCopilot</h1>
            <p className="text-sm text-muted-foreground mt-1">
              Tu copiloto estratégico de contenido
            </p>
          </div>
        </div>
        ...
        <div className="bg-card border border-border rounded-2xl p-8 space-y-6 shadow-xl">
          <div className="text-center">
            <h2 className="text-base font-semibold">Bienvenido</h2>
            <p className="text-sm text-muted-foreground mt-1">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-border bg-secondary hover:bg-accent transition-colors text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {/* Google icon */}
